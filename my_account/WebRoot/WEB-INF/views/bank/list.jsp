...
<meta http-equiv="description" content="银行列表">
...
<script type="text/javascript">
			function news(){
			    	document.location.href='<%=basePath%>bank/add';
			}
			function del(){
				  ...
				  if(value==null){
				  	...
				  	document.location.href='<%=basePath%>bank/delete?id='+value;
				  }
			}
			function edit(){
			    var value = $("#table").find("input[name='cbox']:checked").val();
			    ...
			    if(value==null){
			    	...
			    	document.location.href='<%=basePath%>bank/edit?id='+value;
			    }
			}
			function view(){
			    var value = $("#table").find("input[name='cbox']:checked").val();
			    if(value==null){
			    	...
			    	document.location.href='<%=basePath%>bank/view?id='+value;
			    }
			}
			function box(cb){
...
<body bgcolor='#FFFFFF' text='#000000' leftmargin='0' topmargin='0'
	...
	<sf:form modelAttribute="form" method="GET" cssClass="listForm"
		...
		<table id="table" border="1" class="Table_N" cellspacing="0"
			...
			<tr class="Table_H">
				<td nowrap colspan="13" class="Table_H" height="40">银行列表：</td>
			</tr>
			...
			<tr class="Table_H">
				...
				<td nowrap align="center" width="45%">银行编号</td>
				<td nowrap align="center" width="45%">银行名称</td>
			</tr>

			<c:forEach items="${form.data}" var="bank" varStatus="i">
				<c:choose>
				...
				<tr onclick="clk(this)">
					<td align="center">
						<input type="checkbox" name="cbox"	onClick="box(this)" id="chb" value="${bank.bank_id}" />
					</td>

		...
		<table border="1" class="Table_N" cellspacing="0" cellpadding="5"
			...
			<tr class="Table_H">
				<td nowrap colspan="2" class="Table_H" height="30">买入编辑： 
					...
					<input type="hidden" name="buy_date" value="${buy.buy_date}"/>
					<input type="hidden" name="brokerage" value="${buy.brokerage}"/>
					<input type="hidden" name="brokerage_rate" value="${buy.brokerage_rate}"/>
					<input type="hidden" name="transfer_fee" value="${buy.transfer_fee}"/>
					<input type="hidden" name="costs" value="${buy.costs}"/>
					<input type="hidden" name="the_end" value="${buy.the_end}"/>
					<input type="hidden" name="buy_tolle_money" value="${buy.buy_tolle_money}"/>
				</td>
			</tr>
			<tr>
				<td align="center" width="20%">股票代码</td>
				<td><sf:input path="stock_id" placeholder="股票代码" maxlength="10" size="30" id="stock_id" required="required"/>
					<span id="stock_idTip" style="float:left" ></span>
				</td>
			</tr>
			<tr>

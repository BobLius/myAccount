...
<meta http-equiv="description" content="理财列表">
...
<script type="text/javascript">
			function news(){
			    	document.location.href='<%=basePath%>manageFinances/add';
			}
			function del(){
				  ...
				  if(value==null){
				  	...
				  	document.location.href='<%=basePath%>manageFinances/delete?id='+value;
				  }
			}
			function edit(){
			    var value = $("#table").find("input[name='cbox']:checked").val();
			    ...
			    if(value==null){
			    	...
			    	document.location.href='<%=basePath%>manageFinances/edit?id='+value;
			    }
			}
			function box(cb){
...
<body bgcolor='#FFFFFF' text='#000000' leftmargin='0' topmargin='0'
	...
	<sf:form modelAttribute="form" method="GET" cssClass="listForm"
		...
		<table id="table" border="1" class="Table_N" cellspacing="0"
			...
			<tr class="Table_H">
				<td nowrap colspan="5" class="Table_H" height="40">理财列表：</td>
			</tr>
			<tr class="Table_H" id="simple">
				<td nowrap colspan="5" height="50" valign="middle">
					理财产品名称：<sf:input path="name" />
					<br/>
					记录时间：
			...
			<tr class="Table_H">
				...
				<td nowrap align="center" width="30%">理财名称</td>
				<td nowrap align="center" width="30%">余额</td>
				<td nowrap align="center" width="30%">记录时间</td>
			</tr>

			<c:forEach items="${form.data}" var="manageFinances" varStatus="i">
				<c:choose>
				...
				<tr onclick="clk(this)">
					<td align="center">
						<input type="checkbox" name="cbox"	onClick="box(this)" id="chb" value="${manageFinances.id}" />
					</td>
					<td align="center">${manageFinances.name}</td>
					<td align="center">${manageFinances.money}</td>
					<td align="center">
						<fmt:parseDate value="${manageFinances.record_date}" var="record_date" pattern="yyyyMMdd"/>  

...
<meta http-equiv="description" content="储蓄列表">
...
<script type="text/javascript">
			function news(){
			    	document.location.href='<%=basePath%>bankSave/add';
			}
			function del(){
				  ...
				  if(value==null){
				  	...
				  	document.location.href='<%=basePath%>bankSave/delete?id='+value;
				  }
			}
			function edit(){
			    var value = $("#table").find("input[name='cbox']:checked").val();
			    ...
			    if(value==null){
			    	...
			    	document.location.href='<%=basePath%>bankSave/edit?id='+value;
			    }
			}
			function box(cb){
...
<body bgcolor='#FFFFFF' text='#000000' leftmargin='0' topmargin='0'
	...
	<sf:form modelAttribute="form" method="GET" cssClass="listForm"
		...
		<table id="table" border="1" class="Table_N" cellspacing="0"
			...
			<tr class="Table_H">
				<td nowrap colspan="5" class="Table_H" height="40">储蓄列表：</td>
			</tr>
			<tr class="Table_H" id="simple">
				<td nowrap colspan="5" height="50" valign="middle">
					银行名称：<sf:input path="bank_name" />
					卡号：<sf:input path="card_no" />
					<br/>
					储蓄时间：
			...
			<tr class="Table_H">
				<td nowrap colspan="2" class="Table_H" height="40">
			...
			<tr class="Table_H">
				...
				<td nowrap align="center" width="30%">银行名称</td>
				<td nowrap align="center" width="20%">卡号</td>
				<td nowrap align="center" width="20%">余额</td>
				<td nowrap align="center" width="20%">记录时间</td>
			</tr>

			<c:forEach items="${form.data}" var="bankSave" varStatus="i">
				<c:choose>
				...
				<tr onclick="clk(this)">
					<td align="center">
						<input type="checkbox" name="cbox"	onClick="box(this)" id="chb" value="${bankSave.id}" />
					</td>
					<td align="center">${bankSave.bank.bank_name}</td>
					<td align="center">${bankSave.card_no}</td>
					<td align="center">${bankSave.money}</td>
					<td align="center">
						<fmt:parseDate value="${bankSave.record_date}" var="record_date" pattern="yyyyMMdd"/>  
			            <fmt:formatDate value="${record_date}" type="date" dateStyle="long"/>
					</td>
				</tr>
			</c:forEach>
		</table>

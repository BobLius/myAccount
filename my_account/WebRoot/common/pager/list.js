...
$().ready( function() {
	...
	var $allCheck = $(".listForm input.allCheck");// 全选复选框
	var $idsCheck = $(".listForm input[name='ids']");// ID复选框
	var $deleteButton = $(".listForm input.deleteButton");// 删除按钮
	...
	$idsCheck.click( function() {
		var $idsChecked = $(".listForm input[name='ids']:checked");
	...
	$deleteButton.click( function() {
		...
		var $idsCheckedCheck = $(".listForm input[name='ids']:checked");
		var params = $idsCheckedCheck.serialize();

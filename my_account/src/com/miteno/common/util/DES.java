...
//			System.out.println("step2--->" + temp);
	...
	public static String ASC_2_HEX(String asc) {
		...
		try {
			byte[] bs = asc.toUpperCase().getBytes("GBK");
			for (byte b : bs) {
	...
	/***
	 * 计算MAC(hex)* ANSI-X9.9-MAC(16的整数不补)
...
//			System.out.println("D[" + i + "]=" + D[i]);
	...
	public synchronized static String MAC_3DES(String key, String vector, String data,
			int type) {
		if (type == ASC) {
			data = ASC_2_HEX(data);
		}
...
//		System.out.println(MAC_3DES("23C8131AE651046B1923DF7C8A5B0B6B", null, "0220|020000|80000001|10000000180000001201308021000071", ASC));
	}
}